...
class CurriculumGenerated extends Component {
  render() {
    return (
          ...
          <div className="col s12 backgroundCurriculo">
            <div className="col s5 painelPerfil z-depth-4">
              <div className="row perfil center-align ">
                <img className="circulo" alt="perfil1" src={require('../../images/icon7.png')} />
              </div>
              ...
              <div className="row contactBar center-align">
                <div className="col s12">
                  <h5 className="contactDiv">
                    <img alt="perfil2" src={require('../../images/icon4.png')} width="30" />
                    &nbsp;&nbsp;CONTATOS
                  </h5>
                </div>
              </div>
                ...
                <div className="container">
                  <div className="col s12 contactsBar">
                    <h5 className="emailUser">
                      <img alt="email" src={require('../../images/icon3.png')} width="22" />
              ...
              <div className="row">
                <div className="container">
                  <div className="col s12 contactsBar">
                    <h5 className="emailUser">
                      <img alt="email2" src={require('../../images/icon3.png')} width="22" />
              ...
              <div className="row">
                <div className="container">
                  <div className="col s12 contactsBar">
                    <h5 className="emailUser">
                      <img alt="telefone" src={require('../../images/icon5.png')} width="22" />
                      &nbsp;&nbsp;82999441387
                    </h5>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="container">
                  <div className="col s12 contactsBar">
                    <h5 className="emailUser">
                      <img alt="endereco" src={require('../../images/icon2.png')} width="22" />
              ...
              <div className="row contactBar center-align">
                <div className="col s12">
                  <h5 className="contactDiv">
                    <img alt="objetivos" src={require('../../images/icon1.png')} width="35" />
                    &nbsp;&nbsp;OBJETIVOS
                  </h5>
                </div>
              </div>
              ...
              <div className="row contactBar center-align">
                <div className="col s12">
                  <h5 className="contactDiv">
                    <img alt="idiomas" src={require('../../images/icon6.png')} width="35" />
                    &nbsp;&nbsp;IDIOMAS
                  </h5>
                </div>
              </div>
            ...
            <div className="col s7">
                ...
                <div className="col s12 painelFormacoes right-align">
                  ...
                  <div className="row">
                    <div className="col s12 left-align">
                      <p className="descEx">
                        Descrição: It is a long established fact that a reader will be distracted by
              ...
              <div className="row contactBar center-align z-depth-4">
                <div className="col s12">
                  <h5 className="contactDiv">
                    <img alt="habilidades" src={require('../../images/icon8.png')} width="35" />
                    &nbsp;&nbsp;HABILIDADES
                  </h5>
                </div>
